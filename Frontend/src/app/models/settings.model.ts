export class GymSettings {
  ...
  constructor(data: Partial<GymSettings> = {}) {
    ...
    this.starting_year = data.starting_year!;
    ...
    this.member_can_view_others = data.member_can_view_others;
    this.staff_can_view_trainees = data.staff_can_view_trainees;
    this.enable_alert_email = data.enable_alert_email;
    this.reminder_before_days = data.reminder_before_days;
    this.reminder_message = data.reminder_message;
    this.members_can_message_each_other = data.members_can_message_each_other;
